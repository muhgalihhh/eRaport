            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="index.php">Data Raport Kelas 9</a></li>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kelas" id="kelas" class="form-control">
                                                    ...
                                                    <?php
                                                                $sql = "SELECT * FROM kelas WHERE nama_kelas LIKE 'IX__' ORDER BY nama_kelas ASC";
                                                                $query = mysqli_query($koneksi, $sql);
                                                                while ($data = mysqli_fetch_assoc($query)) {
                                                    ...
                                                    <select name="nama" id="nama" required class="form-control">
                                                        ...
                                                        <?php
                                                                ...
                                                                $sql = "SELECT * FROM siswa_profiles 
                                                                        ...
                                                                        WHERE kelas.nama_kelas LIKE 'IX__'
